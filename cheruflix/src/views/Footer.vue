<template>
    ...
    <footer class="bg-black ">
        ...
        <a href="https://www.youtube.com/channel/UCtjRsPdeXnjqFVtp5GmHZJw" target="_blank" >
       ...
       <p >
        Hic situs ope chatGPT creatus est, dicere possumus optimum situm esse semper in facie terrae. In aliis locis iustus pauper competition       </p> 
       <p>
         2024 — <strong>Stefano Cherubini </strong>
       </p>
   </footer>
 </template>
